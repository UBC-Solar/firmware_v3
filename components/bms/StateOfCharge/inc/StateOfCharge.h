...
float SOCregion1slope = (SOC_PERCENT_THRESHOLD_1 - 100) / (SOC_VOLT_THRESHOLD_1 - SOC_VOLT_MAX);
float SOCregion2slope = (SOC_PERCENT_THRESHOLD_2 - SOC_PERCENT_THRESHOLD_1) / (SOC_VOLT_THRESHOLD_2 - SOC_VOLT_THRESHOLD_1);
float SOCregion3slope = (SOC_PERCENT_THRESHOLD_3 - SOC_PERCENT_THRESHOLD_2) / (SOC_VOLT_THRESHOLD_3 - SOC_VOLT_THRESHOLD_2);
float SOCregion4slope = (0 - SOC_PERCENT_THRESHOLD_3) / (SOC_VOLT_MIN - SOC_VOLT_THRESHOLD_3);
#endif
