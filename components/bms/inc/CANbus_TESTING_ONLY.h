...
CANbus_TESTING_ONLY.h

Purpose: Intended for testing CANbus_functions.c in visual studio 2019.

This file contains things from other header files.
This exists to exclude stm32f303xx.h, because that 
includes another header file that breaks the 
definition of uint32_t, turning it into a variable 
