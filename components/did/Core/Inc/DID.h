...
#define CAN_ID_MCB_REGEN_ENABLED  0x404
...
#define CYCLE_TIME_MCB_REGEN_ENABLED 		100
#define MAX_CYCLE_TIME_MCB_REGEN_ENABLED 	CYCLE_TIME_MCB_DRIVE_STATE * MAX_CYCLE_TIME_INCREASE
