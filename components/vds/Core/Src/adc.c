...
void HAL_ADC_MspInit(ADC_HandleTypeDef *adcHandle)
{
  ...
  if (adcHandle->Instance == ADC1)
  {
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = ST_1_Pin | ST_2_Pin | ST_3_Pin | ST_4_Pin | BP_1_Pin | BP_2_Pin | BP_3_Pin | SA_1_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *adcHandle)
{
  ...
  if (adcHandle->Instance == ADC1)
  {
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, ST_1_Pin | ST_2_Pin | ST_3_Pin | ST_4_Pin | BP_1_Pin | BP_2_Pin | BP_3_Pin | SA_1_Pin);
