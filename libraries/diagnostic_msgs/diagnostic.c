...
// static uint16_t heartbeat_counter = 0;             // Global counter for sequential seconds since board start
...
//  * @return void
//  */
// static void set_diagnostic_CAN_header(CAN_TxHeaderTypeDef* diagnostic_CAN_msg_header, uint32_t can_stdid) {
...
//             UTILS_copy_to_buffer(diagnostic_radio_msg.data, DATA_START_INDEX, DATA_END_INDEX, full_diagnostic_data);
